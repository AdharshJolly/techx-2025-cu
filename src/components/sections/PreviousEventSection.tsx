                  ...
                  <div className="group relative h-full will-change-transform">
                    ...
                    >
                      ...
                      <div className="aspect-[16/10] relative overflow-hidden">
                        ...
                        {/* Scanlines Effect */}
                        <div className="absolute inset-0 pointer-events-none z-20 opacity-30 bg-[linear-gradient(rgba(18,16,20,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))]" style={{ backgroundSize: "100% 2px, 3px 100%" }} />

                        {/* Scanner Bar Animation */}
                        <div className="absolute inset-x-0 h-[2px] bg-neon-cyan/80 shadow-[0_0_10px_rgba(0,255,255,0.8)] z-30 -translate-y-full group-hover:translate-y-[200%] transition-transform duration-1000 ease-in-out opacity-0 group-hover:opacity-100" />
                        ...
                        <div className="absolute top-0 left-0 w-full p-6 bg-gradient-to-b from-black/95 via-black/40 to-transparent z-40">
                           <div className="transform -translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                             <div className="flex items-center gap-2 mb-1">
                               <div className="w-1 h-4 bg-neon-cyan/80 rounded-sm" />
                               <span className="text-neon-cyan/80 font-mono text-xs tracking-wider uppercase">
                                 Event Log 0{index + 1}
                               </span>
                             </div>
                    ...
                    <div className="absolute -bottom-2 -right-2 w-20 h-20 border-b-2 border-r-2 border-neon-cyan/30 rounded-br-3xl -z-10 group-hover:translate-x-1 group-hover:translate-y-1 transition-transform duration-300" />
                    <div className="absolute -top-1 -left-1 w-8 h-8 border-t-2 border-l-2 border-neon-violet/30 -z-10 group-hover:-translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
                  </div>
                </CarouselItem>
              ))}
            </CarouselContent>
