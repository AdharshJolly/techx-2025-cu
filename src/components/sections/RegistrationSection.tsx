        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            {pricingTiers.map((tier) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span
                    className={`font-semibold ${selectedTier.id === tier.id ? "text-foreground" : "text-muted-foreground"}`}
                  >
                    {tier.title}
                  </span>
                </div>
          ...
          >
            <div className="relative w-full aspect-[3/5] md:aspect-[4/5] max-w-sm mx-auto">
              {/* Ticket Glow */}
              <div
                className={`absolute inset-0 transition-colors duration-500 blur-[60px] rounded-full
                 ${
                   selectedTier.color === "primary"
                     ? "bg-primary/20"
                     : selectedTier.color === "secondary"
                       ? "bg-secondary/20"
                       : "bg-accent/20"
                 }
              `}
              ...
              <div className="relative h-full bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden flex flex-col shadow-2xl">
                ...
                {/* Top Section */}
                <div
                  className={`p-8 transition-colors duration-500 bg-gradient-to-b
                   ${
                     selectedTier.color === "primary"
                       ? "from-primary/20"
                       : selectedTier.color === "secondary"
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-right flex flex-col items-end">
                        ...
                        <span className="text-xs text-muted-foreground/80 mt-1 font-medium tracking-wide">
                          (+ GST)
                        </span>
                      </div>
                    </div>
